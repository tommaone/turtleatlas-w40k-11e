...
### Army Rule
- **Army Rule Rating**: Strong — the standard divergent Oath of Moment, reroll-Hits clause only (the +1-to-wound claw is VOID for armies containing DARK ANGELS keyword units — verified), with the month dominated by detachment depth (six 1DP detachments: Dark Age Arsenal, Darkflight Pursuit, Fulguris Task Force, Interrogation Conclave, Subversion Assets, Vengeful Hosts) plus raw momentum: 53.5% -> 63.3% (166 games, 1.77x overrep) and a 7-0 at Warhammer Open Newport. Sourced: listhammer.info/factions/dark-angels 2026-09-05 (63.3%); warpfriends.wordpress.com 2026-08-12 (53.5%); 40k.app/factions/dark-angels/army-rules 2026-09-06 ("If you are using a Codex: Space Marines Detachment and your army does not include one or more units with the BLACK TEMPLARS, BLOOD ANGELS, DARK ANGELS, DEATHWATCH or SPACE WOLVES keywords ... add 1 to the Wound roll as well.").
- **Oath of Moment (reroll-Hits clause only — DA keyword units void +1w)**: Adeptus Astartes army rule referenced throughout the research corpus — units declare an Oath of Moment enemy target and gain targeting-reroll benefits against it [unverified: the base Oath benefit itself is not stated in the corpus; only detachment extensions to it are documented]. Several detachments add wound re-rolls vs the Oath target. Exact per-unit timing/scope not detailed in the DA corpus.
