...
### First-Army Fit
- **First-Army Fit**: Bad — tiny model count makes every mistake catastrophic, plus a huge money/time gate and mono-faction constraints. Sourced: user domain call 2026-09-06.
