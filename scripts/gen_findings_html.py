...
def render_tier_section(tiers):
    ...
    return (
        ...
        'and average dice.</li>\n'
        '      <li>11e matched play uses standardized 16-footprint terrain layouts with '
        'three mission maps (A/B/C) per primary-mission pairing \u2014 maps are more '
        'varied and asymmetric, but map and board-state factors are not modeled here.</li>\n'
