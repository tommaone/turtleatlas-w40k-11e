...
- **Dark Angels** — 79 MFM changelog entries
- **Space Wolves** — 79 MFM changelog entries
- **Space Marines** — 72 MFM changelog entries
- **Black Templars** — 62 MFM changelog entries
- **Blood Angels** — 59 MFM changelog entries
...
- **T'au Empire** — overall 60.6, versatile 85.7
- **Emperor's Children** — overall 60.2, versatile 90.3
